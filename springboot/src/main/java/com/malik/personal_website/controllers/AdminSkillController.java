...
@Tag(name = "Admin skills", description = "CRUD и видимость навыков.")
...
public class AdminSkillController {
    ...
    @PutMapping("/{id}")
    @Operation(summary = "Полностью обновить навык")
    @Parameter(
            name = OpenApiConfig.CSRF_HEADER,
            in = ParameterIn.HEADER,
            required = true,
    ...
    @Operation(summary = "Изменить публичную видимость навыка")
    @Parameter(
            name = OpenApiConfig.CSRF_HEADER,
            in = ParameterIn.HEADER,
            required = true,
